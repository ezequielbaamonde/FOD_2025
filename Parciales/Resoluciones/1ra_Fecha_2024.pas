...
procedure generarInforme (var m: maestro);
 ...
 begin
    ...
    while(regMae.numSuc <> valorAlto) do begin
        ...
        {mientras la sucursal siga siendo la misma}
        while (regMae.numSuc = codSuc) do begin
            ...
            while (regMae.numSuc = codSuc) and (regMae.dni = dniEmp) do begin 
                ...
                {si el año, dni o sucursal no es el mismo}
                writeln(t, fec, cantVentas, montoVentas); //año, cantidad de ventas, Monto de ventas
            ...
            {si el DNI o sucursal cambia, yo tengo que escribir la cantidad de ventas
            total del empleado y montos totales de empleado}
